...
import { phoneChangeOtp } from "../../../apis/user.api";

const PhoneModal = ({ modalOPen, setModalOpen,setUpdate,id}) => {
  ...
  const onSubmit = async (data) => {
    ...
    setIsActive(true);
    const res = await phoneChangeOtp(
      body,
      setIsLoading,
      setOtpData,
      setIsActive,
  ...
  return (
    <>
      ...
      <OtpModal modalOPen={otpOpen} otpData={otpData} setOtpData={setOtpData} setModalOpen={setOtpOpen} setUpdate={setUpdate} />
    </>
  );
};

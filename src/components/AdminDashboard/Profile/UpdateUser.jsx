...
import OtpModal from "@/shared/Modal/OtpModal";
  ...
  return (
    <div>
      ...
      <div className=" mt-8">
        <div className=" bg-white shadow-md rounded-xl p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="w-full mt-[0px]">
            ...
            <div className=" flex items-start gap-5 md:flex-row flex-col mt-2 mb-5">
              <div className="flex flex-col items-start w-full mt-3 mb-[-20px]">
                <label
                  htmlFor="otp"
            ...
            {
              <div className=" flex items-start md:flex-row flex-col gap-5 mt-5">
      ...
      {/* <OtpModal
        ...
        setModalOpen={setOtpOpen}
        setIsActive={setIsActive}
        isActive={isActive}
        setUpdate={setUpdate}
        id={currentlyLoggedIn?._id}
      /> */}

...
const GoldUser = ({ userTypeAdmin,data }) => {
    ...
    <div>
      <div className=" flex items-center justify-between">
        <div>
          ...
          <h2 className=" text-[25px] capitalize font-semibold">{userTypeAdmin} Users</h2>
          <BreakCame
            type={"/admin"}
            data={data}
          />
      ...
      <div className=" bg-white shadow-sm rounded-md mt-5">
        <div className=" p-5 pb-8 hidden md:grid md:grid-cols-3 grid-cols-2 gap-4">
          <input
            type="text"

"use client";
import EditBanner from "@/components/Dashboard/Setting/Banner/EditBanner";
import {
...
console.log(banners)
  ...
  const [getBanner, setGetBanner] = useState(null);
  const {
    register,
    handleSubmit,
    formState: { errors },
      ...
      render: (row) => (
        <>
          <div className="flex items-center gap-2 flex-wrap">
            <EditButton setEditModalOpen={setEditModalOpen} data={row}  setGetBanner={setGetBanner} type={"modal"} />
            <DeleteButton id={row?._id} method={deleteBanner} loading={deleteBannerLoading} error={deleteBannerError}/>
          </div>
        </>
      ),
    },
  ...
  return (
    <>
      ...
      {/* edit banner---------------------------------- */}
      <EditBanner editModalOpen={editModalOpen} setEditModalOpen={setEditModalOpen} data={getBanner} />
